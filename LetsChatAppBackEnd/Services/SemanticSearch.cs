...
public class SemanticSearch(VectorStore vectorStore, AppSettings appSettings)
{
    public async Task<IReadOnlyList<IngestedChunk>> SearchAsync(string text, string? documentIdFilter, int maxResults)
    {
        var vectorCollection = vectorStore.GetCollection<Guid, IngestedChunk>(appSettings.Qdrant.Collections.Chunks);
